...
my $hue = Device::Hue->new(
    { 'debug' => 0, 'bridge' => 'unknown', 'key' => 'unknown' } );
...
say
    "Note: you'll also need an API key that is granted access by the bridge. See http://developers.meethue.com/gettingstarted.html";
say
